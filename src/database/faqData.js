export const faqData = [
  {
    id: 0,
    type: "slava",
    questionText: "Koji sve simboli i natpisi postoje u ponudi?",
    answerText:
      "Žao mi je, nemam odgovor na ovo pitanje! To zavisi isključivo od vas. Inspiraciju za slavske simbole i natpise možete pronaći u postojećoj ponudi, ali budite slobodni da dođete sa svojim idejama. Ja sam tu da se potrudim da vaša očekivanja budu zadovoljena, a poverenje opravdano.",
  },
  {
    id: 1,
    type: "slava",
    questionText: "Da li su proizvodi za višekratnu upotrebu?",
    answerText:
      "Svi radovi na slavskim proizvodima su vodootporni na ručno i na mašinsko pranje do 50 stepeni. Jedini izuzetak su radovi koji sadrže lepljene cirkone. Za njih je preporuka ispiranje u toploj vodi, izbegavati pranje u mašini.",
  },
  {
    id: 2,
    type: "slava",
